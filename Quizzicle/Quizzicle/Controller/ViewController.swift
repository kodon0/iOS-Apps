...
//        Rounded corners
        ...
        let userCorrect = gameLogic.checkAnswer(userAnswer)
...
//        Adding delay
    ...
    @objc func updateUI() {
        questionLabel.text = gameLogic.getQuestionText()
        progressBar.progress = gameLogic.getProgress()
        scoreLabel.text = "Your score is: \(gameLogic.getScore())"
